...
import WidgetProtocolo from "./pages/WidgetProtocolo";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path={"/widget/protocolo"} component={WidgetProtocolo} />
      ...
      <Route path={"/apresentacao-cidadao"} component={PresentationCidadao} />
      <Route path={"/apresentacao-onboarding"} component={PresentationOnboarding} />
